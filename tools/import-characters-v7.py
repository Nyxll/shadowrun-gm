#!/usr/bin/env python3
"""
Import character sheets v7 - Simplified description capture
ALWAYS captures full line text as description, parses for logic separately
"""
import os
import re
...
class CharacterImporterV7:
    """Import characters - captures ALL modifier lines as descriptions"""
        ...
        if attr_section:
            for line in attr_section.group(1).split('\n'):
                ...
                if match:
                    ...
                    # DISABLED: These modifiers are already captured in cyberware/bioware sections
                    # Creating them here results in duplicate/orphaned modifiers
                    # if explanations:
