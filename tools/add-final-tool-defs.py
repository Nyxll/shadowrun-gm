#!/usr/bin/env python3
"""
Add the final 20 tool definitions (Phases 4, 5, 6) to game-server.py
"""
...
# The new tool definitions to add (Phases 4, 5, 6)
new_defs = '''        # ========== PHASE 4: GAME STATE MANAGEMENT ==========
        {
            "type": "function",
            "function": {
...
# Find the end of the tool definitions list (before the closing bracket)
# Look for the pattern that ends Phase 3
pattern = r'(\s+\}\n\s+\}\n)(    \])'

# Replace with the new definitions added before the closing bracket
replacement = r'\1' + new_defs + '\n' + r'\2'
...
print("✅ Added 20 tool definitions (Phases 4, 5, 6) to game-server.py")
print("   - Phase 4: Game State Management (8 tools)")
print("   - Phase 5: Campaign Management (7 tools)")
print("   - Phase 6: Character Management (5 tools)")
print("\n📊 Total tool definitions: 70/70 (100%)")
